...
func (p devicePointer) isNull() bool { _ = "STUB: not implemented"; return false }
...
func getDeviceAllocator() deviceAllocator { _ = "STUB: not implemented"; return *new(deviceAllocator) }
...
func deviceFreeAndSetNil(dp *devicePointer) { _ = "STUB: not implemented"; return }
...
func newDeviceAllocator() deviceAllocator { _ = "STUB: not implemented"; return *new(deviceAllocator) }
...
// deviceFree frees the specified memory from the device. **Slice bound is not checked!!**
func (d *pooledDeviceAllocatorImpl) deviceFree(dp devicePointer) { _ = "STUB: not implemented"; return }
