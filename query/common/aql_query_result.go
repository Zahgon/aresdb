...
func (r AQLQueryResult) SetHLL(dimValues []*string, hll HLL) { _ = "STUB: not implemented"; return }
...
func (r AQLQueryResult) append(row []interface{}) { _ = "STUB: not implemented"; return }

func (r AQLQueryResult) Append(dimValues []*string) { _ = "STUB: not implemented"; return }

// SetHeaders sets headers field for the results
func (r AQLQueryResult) SetHeaders(headers []string) { _ = "STUB: not implemented"; return }
