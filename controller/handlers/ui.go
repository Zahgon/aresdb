...
func NewUIHandler(p UIHandlerParams) UIHandler { _ = "STUB: not implemented"; return *new(UIHandler) }

// Register adds paths to router
func (h UIHandler) Register(router *mux.Router) { _ = "STUB: not implemented"; return }
